...
def send_email(message, recipient, *, sender = "university.help@gmail.com"):
    ...
    mail2 = False # mail1 определяет, правильно или нет введён e-mail отправителя

    for i in recipient: # ищет символ @ в e-mail получателя, возвращает False, если не находит
        if i != '@':
            continue
        else:
            mail1 = True
    ...
    if mail1 == True:
        for i in sender:
            ...
            # присваивает переменной mail2 значение False, если не находит
            if i != '@':
                # print(i)
                continue
            else:
